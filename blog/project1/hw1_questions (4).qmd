...
# Simulate control group as large population
control_pop = np.random.binomial(1, 0.018, 100_000)

# Simulate 10,000 paired draws
control_sample = np.random.choice(control_pop, size=10_000, replace=True)
treatment_sample = np.random.binomial(1, 0.022, 10_000)

# Compute vector of differences
diffs = treatment_sample - control_sample
...
plt.plot(cum_avg, label="Cumulative Avg. Difference", color='darkorange')
